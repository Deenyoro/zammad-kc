...
#   - Top-level rescue calls super to use upstream instruction if anything fails
module Kc
  module TicketTitleRewriterLanguage
    ...
    def instruction
      ...
      Rails.logger.error("KC: TicketTitleRewriterLanguage#instruction failed: #{e.message}, falling back to upstream")
      super
    end
